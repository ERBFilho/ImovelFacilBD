...
import ui.cadastroLocatario.CadastroLocatarioController;
 ...
 * @author khadgar
 */
public class CadastroLocadorController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        System.out.println("---TELA CADASTRO LOCADOR---");
